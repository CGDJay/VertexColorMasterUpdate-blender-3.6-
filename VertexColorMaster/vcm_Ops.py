...
class VERTEXCOLORMASTER_OT_BakeAOChannel(Operator):
    """Bake AO into vertex color"""
    bl_idname = 'vertexcolormaster.bake_ao'
    bl_label = "VCM Apply Isolated Channel"
    bl_options = {'REGISTER', 'UNDO'}
    ...
    def execute(self, context):
        ...
        #bpy.ops.paint.vertex_color_levels(offset=-0.5, gain=3)
        ...
        bpy.context.scene.render.engine = ActiveEngine
        return {'FINISHED'}
...
vcm_EdgeWare,
VERTEXCOLORMASTER_OT_WeightsToColor,
VERTEXCOLORMASTER_OT_ColorToUVs,
VERTEXCOLORMASTER_OT_UVsToColor,
VERTEXCOLORMASTER_OT_ColorToNormals,
VERTEXCOLORMASTER_OT_ColorToWeights,
VERTEXCOLORMASTER_OT_BlendChannels,
VERTEXCOLORMASTER_OT_BakeAOChannel
)
